...
public class TransferExternal extends JFrame implements ActionListener {
    JPanel form = new JPanel();
    JLabel routingNum = new JLabel("Routing Number");
    JLabel accNum = new JLabel("Account Number");
    JLabel tAmount = new JLabel("Transfer Amount");
    JTextField routingNumTxt = new JTextField();
    ...
    public TransferExternal() {
        ...
        this.setTitle("External Transfer");
        this.setLocation();
        this.addComponents();
    ...
    private void setLocation() {
        ...
        this.routingNum.setBounds(10, 20, 150, 30);
        this.routingNumTxt.setBounds(150, 20, 150, 30);
    ...
    private void addComponents() {
        this.form.add(this.routingNum);
        this.form.add(this.routingNumTxt);
